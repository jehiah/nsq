...
var Router = Backbone.Router.extend({
    initialize: function() {
        ...
        this.route(bp('/topology/topics/(:topic)(/:channel)'), 'topology');
    ...
    topology: function(topic, channel) {
        if (channel !== null) {
            Pubsub.trigger('topology:show', topic, channel);
            return;
        }
        Pubsub.trigger('topology:show', topic);
    },
